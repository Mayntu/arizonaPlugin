...
export let options = {
    stages: [
        { duration: '2m', target: 10 },   // 10 пользователей
        { duration: '10m', target: 10 },  // 10 пользователей в течении 10 минут
        { duration: '2m', target: 0 },    // 0 пользователей
    ],
    thresholds: {
        'http_req_duration': ['p(95)<75'], // 95% запросов должны выполняться за 75ms
