...
Скрипт имеет функции для помощи в ловле 👊
⌨️Разная помощь при вводе реальной капчи
🎭Скрытие всех игроков в радиусе.
❗ Удаление разных сообщений в чате.
И другие разные полезные функции...
И добавь что скрипт находится в бета версии и могут возникать баги/ошибки скрипта, вы должны учитывать это перед покупкой 
в пользовательское
